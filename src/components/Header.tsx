...
type THeaderProps = {
  cart: TCartItem[]
  removeFromCart: (id: TGuitar) => void
  increaseQuantity: (id: TGuitar) => void
  decreaseQuantity: (id: TGuitar) => void
  clearCart: () => void
  isEmpty: boolean
  cartTotal: TCartItem
}

export default function Header({ cart, removeFromCart, increaseQuantity, decreaseQuantity, clearCart, isEmpty, cartTotal } : Readonly<THeaderProps>) {
  return (
